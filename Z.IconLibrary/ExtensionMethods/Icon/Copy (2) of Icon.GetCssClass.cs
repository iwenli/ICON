...
{
    /// <summary>
    ///     An Icon extension method that get the 16x16 icon as Bitmap.
    /// </summary>
    /// <param name="this">The @this to act on.</param>
    /// <returns>The 16x16 icon as Bitmap.</returns>
    public static Bitmap GetBitmap16(this Z.IconLibrary.Icon @this)
    {
    ...
    /// <summary>
    ///     An Icon extension method that get the 32x32 icon as Bitmap.
    /// </summary>
    /// <param name="this">The @this to act on.</param>
    /// <returns>The 16x16 icon as Bitmap.</returns>
    public static Bitmap GetBitmap32(this Z.IconLibrary.Icon @this)
    {
        Type enumType = typeof(Z.IconLibrary.Icon);
        var assembly = enumType.Assembly;
        FieldInfo fi = enumType.GetField(@this.ToString());
